...
<main class="flex justify-center">
  <form class="flex flex-col justify-between gap-4 w-3/4 lg:w-3/5 xl:w-1/2">
    ...
    <div class="grid grid-cols-1 2xl:grid-cols-5 bg-white rounded-xl">
      <!-- lower row -->
      <div
        class="flex flex-col p-4 border-b-2 border-r-0 2xl:border-b-0 2xl:border-r-2 sm:border-b-2"
      >
        <!--departure date box -->
      ...
      <div
        class="flex flex-col p-4 border-b-2 2xl:border-b-0 2xl:border-r-2 2xl:border-gray-200 sm:border-b-2"
      >
        <!--retour date box -->
      ...
      <div class="relative flex flex-col p-4 2xl:col-span-2 z-0">
        <!--passenger box -->
      ...
      <button
        type="submit"
        class="flex p-4 justify-center items-center font-bold text-2xl text-white bg-forest-green rounded-b-xl xl:rounded-b-xl 2xl:rounded-b-none 2xl:rounded-r-xl hover:bg-cyprus-green"
      >
        <!--submit button -->
        Search
      </button>
