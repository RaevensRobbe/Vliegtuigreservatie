            ...
            <div class="flex flex-col p-4 border-b-2 lg:border-r-2 lg:border-b-0"> <!--departure box -->
                ...
                <div class="flex mt-1">
                    <svg id="flight_takeoff_black_24dp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="fill-current text-forest-green mr-2 h-6 w-6">
                        ...
                        <path id="Path_14" data-name="Path 14" d="M2.76,26.082h26.5V29H2.76ZM30.05,12.426a2.079,2.079,0,0,0-2.566-1.547l-7.4,2.072L10.458,3.57l-2.691.744L13.54,14.775l-6.931,1.94L3.862,14.469l-2.022.569,3.612,6.551,23.106-6.463a2.234,2.234,0,0,0,1.492-2.7Z" transform="translate(0 0)"/>
                      </svg>
                    <span>Departure</span>
                </div>
            </div>
            <div class="flex flex-col p-4"> <!--destination box -->
                <p class="font-light text-xs">To</p>
                <div class="flex mt-1">
                    <svg id="flight_land_black_24dp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="fill-current text-forest-green mr-2 h-6 w-6">
                        <path id="Path_11" data-name="Path 11" d="M0,0H32V32H0Z" fill="none"/>
                        <path id="Path_12" data-name="Path 12" d="M2.5,26.158h27V29H2.5Zm23.931-4.476a2.134,2.134,0,0,0,1.108-4.121l-7.546-2.018L16.071,2.725,13.328,2V13.766l-7.063-1.89-1.322-3.3L2.884,8.025v7.347Z" transform="translate(0 0)" />
                    </svg>
                    <span>Destination</span>
                </div>
            </div>
        </div>
        <div class="grid grid-cols-1 2xl:grid-cols-5 bg-white rounded-xl"> <!-- lower row -->
            <div class="flex flex-col p-4 border-b-2 border-r-0 2xl:border-b-0 2xl:border-r-2 sm:border-b-2"> <!--departure date box -->
                <p class="font-light text-xs">Departure</p>
                <div class="flex mt-1">
                    <svg id="calendar" class="fill-current text-forest-green mr-2 h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 27">
                        <path id="Path_4" data-name="Path 4" d="M12,13.5a1.5,1.5,0,0,0,0,3H24a1.5,1.5,0,0,0,0-3Z" transform="translate(-4.5 -4.5)"/>
                        <path id="Path_5" data-name="Path 5" d="M9,4.5A4.5,4.5,0,0,0,4.5,9V27A4.5,4.5,0,0,0,9,31.5H27A4.5,4.5,0,0,0,31.5,27V9A4.5,4.5,0,0,0,27,4.5ZM7.5,27V10.5h21V27A1.5,1.5,0,0,1,27,28.5H9A1.5,1.5,0,0,1,7.5,27Z" transform="translate(-4.5 -4.5)" fill-rule="evenodd"/>
                    </svg>  
                    <span>10-06-2021</span>   
                </div>
            </div>
            <div class="flex flex-col p-4 border-b-2 2xl:border-b-0 2xl:border-r-2 2xl:border-gray-200 sm:border-b-2"> <!--retour date box -->
