  ...
  {#if loaded}
    <section>
      {#if busCols !== 0 && busRows !== 0}
        <div>
          <div
            class="grid grid-rows-1 grid-cols-{busCols} grid-flow-col place-items-center gap-2 mb-2"
          >
          ...
          <div
            class="grid grid-flow-col grid-cols-{busCols} grid-rows-{busRows} grid-flow-row place-items-center gap-2"
          >
